...
if (process.argv.length < 3) {
  ...
  console.log('    npx create-rahat-express-app my-app');
  process.exit(1);
}
...
const repo = 'https://github.com/Rahat-Fatura/rahat-node-express-app.git';
...
async function setup() {
  try {
    ...
    console.log();
    console.log('Enjoy your production-ready Rahat Express Node app, which already supports a large number of ready-made features!');
