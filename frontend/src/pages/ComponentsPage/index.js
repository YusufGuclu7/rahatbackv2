...
import GridHeader from "../../components/GridHeader/index.js";
...
function ComponentsPage() {
  ...
  return (
    ...
    >
      ...
      >
        BU SAYFADA UYGULAMALARDA SIKLIKLA KULLANDIĞIMIZ MODALLAR, BUTON VE DİĞER
        BİLEŞENLER YER ALMAKTADIR. LÜTFEN EKSTREM DURUMLAR DIŞINDA, BU YAPILARI
        KULLANMAYA ÖZEN GÖSTERİNİZ. KOD ANLAŞILABİLİRLİĞİ VE BÜTÜNLÜĞÜ AÇISINDAN
        BU ÖNEMLİDİR. BU SAYFAYI SİLMEYİP KOPYALAYARAK İLERLEMENİZ TAVSİYE
        EDİLİR. BOL ŞANS :D
      </Alert>
      ...
      >
        ...
        >
          ...
          <Autocomplete
            options={options}
            sx={{
              width: "250px", // Box ile aynı genişlik
              backgroundColor: "#ffffff",
        ...
        >
          <LocalizationProvider dateAdapter={AdapterMoment} adapterLocale="tr">
            <Grid sx={{ display: "flex", alignItems: "center", gap: 1 }}>
              <IconButton onClick={handlePreviousMonth} className="date-button">
              ...
              <DateRangePicker
                ...
                sx={{ height: "40px" }} // Standart yükseklik
              />
      ...
      >
        <GridHeader
          title="Yüklenen Defteler"
          length={rowData?.length}
          icon={<TableView />}
        ></GridHeader>

        {/* Grid Container - className korunuyor */}
        <Box
